<script lang="ts">
    ...
    //END OF SCRIPT FOR Sveltekit Netlify Porter//
                ...
                <noscript>
                    ...
                    <p>We don't do any tracking or anything like that though (except some <a href="https://umami.is">privacy-respecting analytics</a>), if that's your concern.</p>
                </noscript>
                ...
                >
                    ...
                    <div class="message-wrapper field">
                        <label class="labelone" for="message">Message:</label>
                        <textarea name="message" bind:value={formData.message} rows="6" placeholder="What services are you interested in?"></textarea>
                    </div>
            ...
            {:else}
                    <p class="meh">
                    Thank you for your interest, we appreciate and value your patronage!
                    </p>
                {/if}
